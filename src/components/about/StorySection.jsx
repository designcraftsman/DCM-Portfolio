                ...
                <div className="container my-5 py-5">
                    <div className="row">
                        ...
                        <div className="col-12 my-5 reveal-element">
                            <img src="https://images.pexels.com/photos/29393022/pexels-photo-29393022/free-photo-of-chien-robot-dans-un-decor-interieur-avec-des-chaises-rouges.jpeg?auto=compress&cs=tinysrgb&w=" className="about-content-image" alt="" />
                        </div>      
                    </div>
                </div>
            </div>
